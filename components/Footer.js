...
import { Twitter, Facebook, Inst, Logo, Insta } from "./index";
...
const Footer = () => {
  ...
  return (
    <footer className="px-4 divide-y bg-[#1A1A1A] text-gray-100">
      <div
        className="comtainer flex flex-col justify-between py-10 mx-auto space-y-8
    lg:flex-row lg:space-y-0"
      >
        <div className="lg:w-1/3">
          <a
            ...
            href="#"
            className="flex jsutofy-center space-x-3 lg-justify-start"
          >
            <div
        ...
        <div
          className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3
      sm:grid-cols-4"
        >
          ...
          <div className="space-y-3">
            <div className="tracki uppercase text-[#7765F3]">Social media</div>
      ...
      text-gray-400">
        &copy; 2025 @oluwatobi. All rights reserved.
      </div>
    </footer>
  );
};
